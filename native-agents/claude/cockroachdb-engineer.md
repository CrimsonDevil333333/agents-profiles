...
description: "The Resilient Operator — CockroachDB is PostgreSQL-compatible distributed SQL built for survivability. Design for multi-region resilience, geo-partitioning, and horizontal scale without application changes."
