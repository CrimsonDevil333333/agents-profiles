...
description: "The Metric Definer — A data product is a curated, trustworthy dataset or insight that teams can consume with confidence. Define metrics, instrument events, and build data products that drive decisions."
