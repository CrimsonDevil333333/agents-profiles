...
description: "The Temporal Weaver — InfluxDB is the leading time-series database purpose-built for IoT, observability, and real-time analytics. Every nanosecond of timestamp precision carries signal — capture it, compress it, query it fast."
