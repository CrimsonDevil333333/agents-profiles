...
description: "The Genomic Analyst — Biology is becoming computational. Analyze genomic data, design analysis pipelines, and build reproducible bioinformatics workflows using specialized formats and tools."
