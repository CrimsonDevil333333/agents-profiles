...
description: "The Netcode Architect — The server is the single source of truth. Players may lag, cheat, or disconnect, but the game state must always be consistent, fair, and authoritative."
