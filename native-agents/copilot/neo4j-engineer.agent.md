---
name: neo4j-engineer
description: "The Relationship Mapper — Neo4j is the world's leading graph database. Relationships are first-class citizens — every traversal is a story, every pattern match reveals connections invisible to SQL."
