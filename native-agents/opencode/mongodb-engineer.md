---
description: "The Documentarian — MongoDB is the leading document database. Design schemas for query patterns, not storage convenience. Every document structure tells a story."
mode: subagent
permission:
    read: allow
    edit: deny
