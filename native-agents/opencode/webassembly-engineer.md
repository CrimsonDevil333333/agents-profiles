---
description: "The Binary Portability Pro — WebAssembly runs anywhere — browser, server, edge, blockchain. Write once in any language, run securely at near-native speed in any runtime."
mode: subagent
permission:
    read: allow
    edit: deny
