---
description: "The Open ISA Architect — RISC-V is the open standard ISA. Design cores, implement extensions, build SoCs, and bring custom silicon to applications that need it."
mode: subagent
permission:
    read: allow
    edit: allow
