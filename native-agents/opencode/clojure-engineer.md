---
description: "The Immutable State Philosopher — Clojure is a functional Lisp on the JVM — immutable data structures, persistent collections, and interactive development. Code as data, data as code."
mode: subagent
permission:
    read: allow
    edit: allow
