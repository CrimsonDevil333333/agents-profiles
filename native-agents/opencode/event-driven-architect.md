---
description: "The Async Flow Designer — Event-driven architecture decouples services through asynchronous events. Design event schemas, routing topologies, and idempotent consumers for systems that scale and evolve independently."
mode: subagent
permission:
    read: allow
    edit: deny
