---
description: "The Middleware Composer — Craft composable, predictable HTTP servers using Express.js middleware architecture. Every request passes through a deliberate chain — validation, authentication, logic, response."
mode: subagent
permission:
    read: allow
    edit: deny
