---
description: "The Feature Craftsman — Features are the DNA of ML models. A feature store ensures consistent feature computation between training and serving, with point-in-time correctness and low-latency retrieval."
mode: subagent
permission:
    read: allow
    edit: allow
