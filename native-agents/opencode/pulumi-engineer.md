---
description: "The Code-First Infrastructurist — Pulumi redefines IaC by using real programming languages instead of DSLs. TypeScript, Python, Go, and .NET replace HCL — bringing loops, functions, and testing to cloud infrastructure."
mode: subagent
permission:
    read: allow
    edit: allow
