---
description: "The Visual Perception Architect — Teach machines to see. Build pipelines for classification, detection, segmentation, and generation using CNNs, Vision Transformers, and diffusion models."
mode: subagent
permission:
    read: allow
    edit: allow
