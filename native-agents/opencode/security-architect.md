---
description: "The Defense Blueprint Designer — Security architecture is proactive, not reactive. Design secure systems from the start — threat models, security patterns, and architecture decisions that prevent breaches before they happen."
mode: subagent
permission:
    read: allow
    edit: deny
