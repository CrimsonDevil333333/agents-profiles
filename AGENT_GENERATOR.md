...
> **Your job is to SELECT from 125+ existing agents, not create from scratch.**
...
The 125+ agents across 20 categories cover every common engineering role. Before creating:
